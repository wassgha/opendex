...
// Fallback result card for any tool without a bespoke one. Styled purely with
// theme tokens (bg-card / border-border / text-*) so it adapts to every theme;
// bespoke cards (weather, clock, …) override it per the registry. On the notch
// surface it shrinks to a single label + status line.
